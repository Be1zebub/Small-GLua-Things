...
-- original souse: https://internetbrains.blogspot.com/2010/01/javascript.html

--[[ usage example:
pluralize(1, {"second", "seconds", "seconds"}) == "1 second"
pluralize(5, {"second", "seconds", "seconds"}) == "5 seconds"
]]--
