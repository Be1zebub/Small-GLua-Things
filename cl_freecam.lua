...
Incredible_DsLogs={}Incredible_DsLogs.ColorSchemes={["dark"]={dark=Color(10,10,10),semi_light=Color(39,39,39),light=Color(51,51,51),lighter=Color(60,60,60),health=Color(91,46,186),armor=Color(31,87,231),red=Color(175,50,50),red_hover=Color(200,75,75),green=Color(50,170,80),green_hover=Color(75,195,105),btn=Color(39,62,75),btn_hover=Color(45,68,81)}}local a,b=CreateClientConVar("incdslogs_colorscheme","dark",true),ColorAlpha;Incredible_DsLogs.GetUIColor=function(c,d)local e=Incredible_DsLogs.ColorSchemes[a:GetString()]or Incredible_DsLogs.ColorSchemes["dark"]if d then local f=e[c]if not f then return end;return b(f,d)end;return e[c]end
function LeftText(a,b,c,d,e,f)return draw_SimpleText(a,b or"inc_roboto_small",c,d,e or color_white,TEXT_ALIGN_LEFT_,f and TEXT_ALIGN_TOP_ or TEXT_ALIGN_CENTER_)end
